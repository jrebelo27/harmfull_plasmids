...
def bacterial_growth (focal_bacterium, list_spaces, filled_spaces):    
    ...
    if len(empty_positions) > 0:
        ...
        local_neighbours_type, list_spaces = function_local_neighbourhood(new_x, new_y, list_spaces, focal_bacterium[2])
        type_nutrient_neighbourhood, list_spaces = function_nutrient_neighbourhood(new_x, new_y, list_spaces, focal_bacterium[2])
        filled_spaces.append([new_x, new_y])           
        if focal_bacterium[2] == 1:
            cost = 0
        ...
        list_spaces[new_x][new_y] = [new_x, new_y, focal_bacterium[2], cost, local_neighbours_type, type_nutrient_neighbourhood, decreased_time]
