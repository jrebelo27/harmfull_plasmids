...
def cycles (list_spaces, filled_spaces):
    ...
    while number_times_full_grid <= 1073:        
        ...
        if c > 0:
            ...
            #conjugation            
            if focal_bacteria[2] == 2 or focal_bacteria[2] == 3:                
            ...
            if len(filled_spaces)/grid_area >= variables.maximum_proportion_full_grid:            
                ...
                for each_x_space in range(len(list_spaces)):
                    for each_y_space in range(len(list_spaces[0])):
                        if list_spaces[each_x_space][each_y_space][2] == 1:
                            ...
                            segregadas += 1  
                final_data.append([recipients, donors, transconjugants,segregadas,variables.number_adaptations, each_cycle])        
                ...
                if (recipients+segregadas) == 950000 or (donors+segregadas) == 950000 or (transconjugants+segregadas) == 950000:
